...
@Component({
  ...
  templateUrl: './investor-register.component.html',
  styleUrls: ['./investor-register.component.css']
})
export class InvestorRegisterComponent implements OnInit {
 ...
 pwdmatch(pwd: any, confpwd: any){
  ...
  onSubmit(){
    var investorData = {
      ...
      amountinvested: this.myform.value.amountinvested,
    }
    this.service.addInvestor(investorData).subscribe((res) =>{
