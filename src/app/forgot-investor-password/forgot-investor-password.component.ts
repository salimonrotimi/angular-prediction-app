...
@Component({
  selector: 'app-forgot-investor-password',
  templateUrl: './forgot-investor-password.component.html',
  styleUrls: ['./forgot-investor-password.component.css']
})
export class ForgotInvestorPasswordComponent implements OnInit {
 ...
 pwdmatch(pwd: any, confpwd: any){
  ...
  onSubmit(){
    ...
    this.service.updateInvestorPassword(logindata).subscribe((res) =>{
